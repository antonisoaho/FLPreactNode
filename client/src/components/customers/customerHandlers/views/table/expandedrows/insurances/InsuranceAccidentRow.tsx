...
import { InsuranceAccident } from '../../../../edit/forms/models/CustomerFormModels';
import ColoredTableRow from '../../../../../../../commonComponents/coloredTableRow/ColoredTableRow';

interface RowProps {
  fields: [InsuranceAccident & DateFields];
}

const InsuranceAccidentRow: React.FC<RowProps> = ({ fields }) => {
  return (
    <TableRow>
